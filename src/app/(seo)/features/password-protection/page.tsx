...
const PasswordProtectionPage: FCC = () => {
   return (
      <MaxWidthContainer>
         <AnimationContainer
            delay={0.1}
         ...
         >
            ...
            >
               <MagicBadge title="Protect your password" />
               <h1 className="!leading-tight mt-6 text-center font-heading font-semibold text-2xl md:text-4xl lg:text-5xl">
                  Freezing your content with a password
               </h1>
               <p className="mt-6 text-center text-base text-muted-foreground md:text-lg">
                  Safeguard sensitive information with robust password
                  protection, providing peace of mind and enhanced security.
               </p>

         ...
         >
            ...
            >
               ...
               <p className="mt-6 text-center text-base text-muted-foreground md:text-lg">
                  Simplify your workflow with powerful SEO management tools.
                  Content delivery, AI suggestions, and optimize your content
                  with ease.
               </p>
